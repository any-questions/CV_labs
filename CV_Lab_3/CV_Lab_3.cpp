...
int main() {
    // task 1
    cv::Mat img1 = cv::imread("source_img/img_zadan/allababah/ig_0.jpg");
    cv::Mat img2 = cv::imread("source_img/img_zadan/allababah/ig_1.jpg");
    cv::Mat img3 = cv::imread("source_img/img_zadan/allababah/ig_2.jpg");
    cv::Mat temp;
    ...
    // task2
    cv::Mat img4 = cv::imread("source_img/img_zadan/teplovizor/21331.res.jpg");
    cv::Mat img5 = cv::imread("source_img/img_zadan/teplovizor/445923main_STS128_16FrAvg_color1.jpg");
    cv::Mat img6 = cv::imread("source_img/img_zadan/teplovizor/MW-AW129-measured.jpg");
    cv::Mat img7 = cv::imread("source_img/img_zadan/teplovizor/ntcs_quest_measurement.png");
    cv::Mat img8 = cv::imread("source_img/img_zadan/teplovizor/size0-army.mil-2008-08-28-082221.jpg");
    ...
    // task3
    cv::Mat img9 = cv::imread("source_img/img_zadan/roboti/roi_robotov.jpg");
    cv::Mat img10 = cv::imread("source_img/img_zadan/roboti/roi_robotov_1.jpg");
    ...
    // task4
    cv::Mat img11 = cv::imread("source_img/img_zadan/gk/gk.jpg");
    cv::Mat img12 = cv::imread("source_img/img_zadan/gk/gk_tmplt.jpg");
    ...
    cv::VideoCapture cap("source_img/pics_2/Robot_Swarm_cutted.mp4");
